...
public class Config {
    ...
    public static final ConfigurationHolder<String> DATABASE_PREFIX =
            new ConfigurationHolder<>("database.prefix", String.class);
    public static final ConfigurationHolder<String> DATABASE_HOST =
            new ConfigurationHolder<>("database.host", String.class);
    public static final ConfigurationHolder<String> DATABASE_DBNAME =
            new ConfigurationHolder<>("database.dbname", String.class);
    public static final ConfigurationHolder<String> DATABASE_USER =
            new ConfigurationHolder<>("database.user", String.class);
    public static final ConfigurationHolder<String> DATABASE_PASS =
            new ConfigurationHolder<>("database.pass", String.class);
